...
JetHists::JetHists(Event::Container container, int idx, const std::string& title)
...
void JetHists::initialize(TheEvent *event)
{
  ...
  JetInfoSwitch *infoSwitch=&dynamic_cast<Event*>(event)->m_jets->m_infoSwitch;
